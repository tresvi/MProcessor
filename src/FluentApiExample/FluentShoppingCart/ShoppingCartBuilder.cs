...
{
    public class ShoppingCartBuilder : IClientBuilder, IItemBuilder, ICheckoutBuilder, IDeliveryBuilder, IPaymentBuilder
    {
        ShoppingCart _cart;
        ...
        public IItemBuilder AddItem(Func<IItemBuilderStep1, Item> itemConfigurator)
        {
        ...
        public IItemBuilder ForClient(string name)
        {
        ...
        IDeliveryBuilder ICheckoutBuilder.Checkout()
        {
